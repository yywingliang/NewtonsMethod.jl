...
f(x)=x^2
f′(x)=2x
@test newtonroot(f,f′,x₀=0.5).root ≈ 0.0

f(x)=x^3-3x^2+2
f′(x)=3x^2-6x
@test newtonroot(f,f′,x₀=0.5).root ≈ 1.0
...
f(x)=x^2
@test newtonroot(f,x₀=0.5).root ≈ 0.0

f(x)=x^3-3x^2+2
@test newtonroot(f,x₀=0.5).root ≈ 1.0
...
f(x)=sin(x)-1
f′(x)=cos(x)
@test newtonroot(f, f′, x₀ = BigFloat(1.0), tolerance = 1E-32).root ≈ BigFloat(pi/2)
@test newtonroot(f, x₀ = BigFloat(1.0), tolerance = 1E-32).root ≈ BigFloat(pi/2)
